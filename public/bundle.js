...
var app = (function () {
    ...
    class NavLink extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "NavLink", options, id: create_fragment$3.name });
    	}
    ...
    var ajax = async function(method = 'GET', url = '') {
    ...
    function create_fragment$5(ctx) {
    	var section, input0, t0, input1, t1, input2, dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			input0.value = email;
    			add_location(input0, file$2, 21, 4, 756);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "name", "password");
    			attr_dev(input1, "placeholder", "Password");
    			input1.value = password;
    			add_location(input1, file$2, 22, 4, 830);
    			attr_dev(input2, "type", "submit");
    			input2.value = "Sign In";
    			add_location(input2, file$2, 23, 4, 916);
    			add_location(section, file$2, 20, 0, 742);
    			dispose = listen_dev(input2, "click", ctx.click_handler);
    		},
    ...
    const file$3 = "src/routes/admin/Dashboard.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file$3, 24, 4, 696);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(24:0) {#each users as user}", ctx });
    	return block;
    }

    function create_fragment$6(ctx) {
    	var h1, t1, p, t3, each_1_anchor;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "Welcome to the Admin side";
    			t3 = space();
    			...
    			add_location(p, file$3, 21, 0, 636);
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
        ...
        onMount(() => {
            ...
            ajax('GET', url).then(response => $$invalidate('users', users = response));
        });
    ...
    class Dashboard extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Dashboard", options, id: create_fragment$6.name });
    	}
    }
    ...
    function create_default_slot_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot_3.name, type: "slot", source: "(14:1) <NavLink to=\"/\">", ctx });
    	return block;
    }

    // (15:1) <NavLink to="login">
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot_2.name, type: "slot", source: "(15:1) <NavLink to=\"login\">", ctx });
    	return block;
    }

    // (16:1) <NavLink to="dashboard">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot_1.name, type: "slot", source: "(16:1) <NavLink to=\"dashboard\">", ctx });
    	return block;
    }

    // (12:0) <Router url="{url}">
    function create_default_slot$1(ctx) {
    	var nav, t0, t1, t2, t3, t4, current;
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			route2.$$.fragment.c();
    			add_location(nav, file$4, 12, 2, 378);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_default_slot$1.name, type: "slot", source: "(12:0) <Router url=\"{url}\">", ctx });
    	return block;
    }
